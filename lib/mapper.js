...
module.exports.opModeFromTargetState = function (targetState) {
    switch (targetState) {
        ...
        case Characteristic.TargetHeaterCoolerState.AUTO: 
            return OpMode.Auto;
        default: 
            console.warn("Unknown target state received:", targetState);
            return OpMode.Auto; // Default fallback
    }
};
...
module.exports.targetStateFromOpMode = function (opMode) {
    switch (opMode) {
        ...
        case OpMode.Dry:
        case OpMode.Wind: 
            return Characteristic.TargetHeaterCoolerState.AUTO; // Best match
        default: 
            console.warn("Unknown operation mode received:", opMode);
            return Characteristic.TargetHeaterCoolerState.AUTO; // Fallback
    }
};
...
module.exports.rotationSpeedFromWindLevel = function (windLevel) {
    switch (windLevel) {
        ...
        default:
            console.warn("Unknown wind level received:", windLevel);
